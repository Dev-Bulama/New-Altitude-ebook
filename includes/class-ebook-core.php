 ...
 * Properly initializes all components with constructors
 *
...
require_once SKILLSCORE_EBOOK_PLUGIN_DIR . 'includes/class-email-campaign.php';
require_once SKILLSCORE_EBOOK_PLUGIN_DIR . 'includes/class-campaign-scheduler.php';
require_once SKILLSCORE_EBOOK_PLUGIN_DIR . 'includes/class-campaign-metabox.php';
require_once SKILLSCORE_EBOOK_PLUGIN_DIR . 'includes/class-campaign-admin-page.php';
    }

    /**
     * Register admin-specific hooks - FIXED TO USE CONSTRUCTORS
     */
    private function define_admin_hooks() {
        // Register custom post type - INSTANTIATE WITH CONSTRUCTOR
        ...
        // Admin settings - INSTANTIATE WITH CONSTRUCTOR
        ...
        // Email campaign system
new SkillScore_Email_Campaign();
new SkillScore_Campaign_Scheduler();
new SkillScore_Campaign_Metabox();
new SkillScore_Campaign_Admin_Page();
    }
