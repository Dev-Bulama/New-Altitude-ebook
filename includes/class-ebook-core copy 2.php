 ...
 * Now automatically loads single ebook template
 *
...
class SkillScore_Ebook_Core {
    ...
    private function define_public_hooks() {
        ...
        // FIX: Automatically load single ebook template
        add_filter('template_include', array($this, 'load_single_ebook_template'), 99);
        
        // FIX: Add ebook content to single pages
        add_filter('the_content', array($this, 'add_ebook_content_to_single'));
    }
    ...
    /**
     * Load custom template for single ebook pages.
     * FIX: This ensures single ebook pages use our template
     */
    public function load_single_ebook_template($template) {
        if (is_singular('ebook')) {
            // Use a blank template wrapper
            $plugin_template = SKILLSCORE_EBOOK_PLUGIN_DIR . 'templates/single-ebook-wrapper.php';
            
            // If wrapper doesn't exist, create it on the fly
            if (!file_exists($plugin_template)) {
                return $template; // Fall back to theme template
            }
    ...
    /**
     * Add ebook content to single ebook pages.
     * FIX: This adds our ebook display to the content
     */
    public function add_ebook_content_to_single($content) {
        ...
        // Generate ebook content using the shortcode method
        ob_start();
        
        // Manually call the render method
        ...
        $ebook_content = ob_get_clean();
        
        // Replace the default content with our ebook content
